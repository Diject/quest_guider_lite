...
---@field objects string[]? several record ids, objects with these ids will be tracked by the marker
...
---@field gridX integer? for exterior cells
---@field gridY integer? for exterior cells
