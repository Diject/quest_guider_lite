...
return {
    ...
    [types.requirementType.CustomActorGender] = { str = "Someone's gender is #operator# #maleFemaleValue#", priority = -1001 },
    ...
    [types.requirementType.NPCTalkedToPlayer] = { str = "#objectName# talked to the player #isBeforeValue#", },
    [types.requirementType.CustomSkill] = { str = "#skillName# of #objectName# is #operator# #value#", },
    [types.requirementType.PlayerGender] = { str = "The player's gender is #operator# #maleFemaleValue#", },
    ...
    [types.requirementType.CustomDisabled] = { str = "Disabled state of the object is #operator# #trueFalseValue#", priority = -1001 },
    ...
    [types.requirementType.CustomOnKnockout] = { str = "#objectName# is#notContr# knocked out", priority = -1001 },
    [types.requirementType.NotActorFaction] = { str = "The NPC's faction is#negNotContr# #operator# #varName#", priority = -1001 },
    [types.requirementType.CustomRace] = { str = "Race of #objectName# is#notContr# \"#varName#\"", priority = -1001 },
    ...
    [types.requirementType.CustomHasSoulgem] = { str = "The player has #operator# #value# soulgem(s) containing soul of #varName#", },
